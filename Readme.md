...
* Студент: [Инна Лютикова](https://up.htmlacademy.ru/htmlcss/34/user/1912271).
* Наставник: `Артур Гамиди`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/1912271-sedona-34) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
